--ALTER TABLE StudentExercise  WITH CHECK ADD CONSTRAINT [FK_SE_Student] FOREIGN KEY ([StudentId]) REFERENCES Student ([StudentId]) ON DELETE CASCADE 
USE MASTER
GO
...
ALTER TABLE StudentExercise  WITH CHECK ADD CONSTRAINT [FK_StudentExercise_Student] FOREIGN KEY ([StudentId]) REFERENCES Student ([Id]) ON DELETE CASCADE 
